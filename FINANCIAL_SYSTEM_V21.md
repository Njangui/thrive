...
- Les données historiques dont flexco  ne possède pas le coût unitaire réel sont traitées avec le coût disponible en base ; les nouvelles commandes disposent d'un snapshot de coût.
