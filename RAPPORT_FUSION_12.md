...
travaillée vous-même (511 fichiers, déjà rebrandée **flexco ** — `name`
dans `package.json`, `flexco Brand`, `.mkt-*`/`.adm-*` avec les couleurs
...
flexco  lui-même) affiche ce lien, une vitrine tenant n'a pas de notion
