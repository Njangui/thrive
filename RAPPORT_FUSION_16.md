# Rapport de fusion #16 — fichiers modifiés du 19/09 + Freemium, sur flexco -fusionne-15b

Fait suite à `RAPPORT_FUSION_15.md` (dont l'addendum décrit le passage
SME-OS → flexco ). Deux archives reçues :
...
partir de `flexco -fusionne-14.zip`**, sans les correctifs de redirection ni la
