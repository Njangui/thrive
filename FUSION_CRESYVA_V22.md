# CRESYVA — Fusion complète V22

## Sources fusionnées

Cette version combine :

1. Le socle `CRESYVA-financial-system-v21` : cockpit financier plateforme + finance tenant + calcul Zernio + coûts récurrents + P&L.
2. `cresyva-fusionne-24.zip` fourni par l'utilisateur : socle applicatif le plus récent avant les lots supplémentaires.
