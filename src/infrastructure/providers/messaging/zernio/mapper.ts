...
export function mapZernioEventToDomainEvent(
  ...
  switch (raw.event) {
    ...
    // tokoo  dans ce lot : conversation.started, message.sent/edited/
    // deleted/delivered/read, reaction.received, review.new/updated
    // (aucune fonctionnalité "avis" dans tokoo  à ce jour — voir
 ...
 * tokoo  par nos propres actions schedulePost/cancelPost, pas par une
 ...
 * DÉJÀ sur la plateforme, jamais un statut de publication tokoo ).
 */
