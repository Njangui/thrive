 ...
 * `trackExternalPost` (détection d'un post publié hors CRESYVA) et surtout `handleIncomingComment`
...
describe("trackExternalPost — détection d'un post publié hors CRESYVA", () => {
