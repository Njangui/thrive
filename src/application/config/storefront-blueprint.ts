...
const RETAIL: StorefrontBlueprint = {
  ...
  heroSubtitle: (name) => `Découvrez les produits publiés par ${name}, puis contactez-nous pour organiser votre commande.`,
  ...
  defaultAccent: { primary: "#171714", secondary: "#D89B5D" },
  highlights: [
    { icon: "bag", title: "Une sélection visible", subtitle: "Découvrez les produits publiés" },
    { icon: "truck", title: "Commande simplifiée", subtitle: "Retrouvez les informations utiles" },
    { icon: "wallet", title: "Informations claires", subtitle: "Prix et disponibilité affichés" },
...
const RESTAURANT: StorefrontBlueprint = {
  ...
  highlights: [
    { icon: "chef", title: "Notre carte en ligne", subtitle: "Découvrez les plats publiés" },
    { icon: "clock", title: "Informations pratiques", subtitle: "Horaires et contact affichés", requires: "openingHours" },
    { icon: "leaf", title: "Découvrez la maison", subtitle: "Cuisine, ambiance et informations utiles" },
    { icon: "headset", title: "Contact direct", subtitle: "Échangez avec l'établissement", requires: "whatsapp" },
  ],
...
const BEAUTY: StorefrontBlueprint = {
  ...
  heroSubtitle: (name) => `Prestations sur rendez-vous chez ${name} — découvrez les soins, les tarifs publiés et demandez votre créneau.`,
  ...
  highlights: [
    { icon: "calendar", title: "Prendre rendez-vous", subtitle: "Choisissez une prestation et demandez un créneau" },
    { icon: "scissors", title: "Nos prestations", subtitle: "Tarifs et durées affichés lorsqu'ils sont renseignés" },
    { icon: "sparkles", title: "Nos réalisations", subtitle: "Découvrez les images publiées par le salon" },
    { icon: "wallet", title: "Tarifs transparents", subtitle: "Les prix viennent directement du catalogue" },
  ],
...
const PROFESSIONAL_SERVICES: StorefrontBlueprint = {
  ...
  heroSubtitle: (name) => `Découvrez les services de ${name}, leur périmètre et les informations utiles avant de prendre contact.`,
  ...
  highlights: [
    { icon: "briefcase", title: "Services présentés clairement", subtitle: "Périmètre et informations utiles" },
    { icon: "handshake", title: "Échange direct", subtitle: "Un contact simple avec l'entreprise" },
    { icon: "clock", title: "Prochaines étapes visibles", subtitle: "Services, contact et rendez-vous au même endroit" },
    { icon: "shield", title: "Informations accessibles", subtitle: "Retrouvez l'essentiel avant de nous contacter" },
  ],
...
const REAL_ESTATE: StorefrontBlueprint = {
  ...
  heroSubtitle: (name) => `${name} vous présente les biens publiés, avec les informations disponibles et la possibilité de demander une visite.`,
  ...
  highlights: [
    { icon: "key", title: "Biens présentés", subtitle: "Découvrez les annonces publiées" },
    { icon: "wallet", title: "Prix affichés", subtitle: "Lorsque le prix est renseigné" },
    { icon: "ruler", title: "Fiches détaillées", subtitle: "Retrouvez les informations publiées" },
    { icon: "calendar", title: "Organiser une visite", subtitle: "Demandez un créneau via le site" },
  ],
...
const DEFAULT: StorefrontBlueprint = {
  ...
  // Composition par défaut inspirée des maquettes fournies : hero immersif,
  // catégories/offre, éléments en vedette, histoire, services, preuve sociale
  // puis CTA/contact. Elle reste volontairement générique pour une entreprise
  // dont le secteur n'a pas encore été renseigné.
  sections: ["hero", "categories", "products", "services", "about", "gallery", "testimonials", "faq", "contact"],
  newBadgeLabel: "Nouveau",
