...
export default async function GroupsPage({
  ...
  // Lot M — file d'attente d'activation : groupes connectés côté tokoo 
            ...
            <tbody>
              {connectedGroups.map((g) => (
                <tr key={g.id} className="border-b border-navy-900/5 last:border-0">
                  ...
                  <td
                    className="px-2 py-2"
                    title="Une diffusion ne peut atteindre ce groupe que si tokoo  dispose déjà d'une conversation active avec lui."
                  >
                    {g.isSendable ? (
