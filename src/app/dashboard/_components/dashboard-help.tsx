...
const GUIDES: Record<string, { title: string; intro: string; steps: string[]; tip?: string }> = {
  ...
  "/dashboard/leads": {
    ...
    tip: "tokoo  propose automatiquement une relance à 24 h ou 48 h selon l'engagement observé.",
  },
  "/dashboard/orders": {
  ...
  "/dashboard/finance": {
    ...
    intro: "Utilisez cette page pour suivre les encaissements, dépenses et mouvements enregistrés dans tokoo .",
    steps: [
  ...
  "/dashboard/channels": {
    ...
    intro: "Chaque connexion se fait depuis tokoo  avec des étapes guidées. Aucun réglage technique n'est nécessaire au quotidien.",
    steps: [
      "Choisissez le canal à connecter.",
      "Suivez l'autorisation officielle affichée par le service concerné.",
      "Revenez dans tokoo  et vérifiez que le statut passe à Connecté.",
