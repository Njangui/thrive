...
export async function POST(request: Request) {
  ...
  for (const rawEvent of rawEvents) {
    ...
    try {
      ...
      // Lot 5 — post détecté nativement sur la plateforme (hors tokoo ),
      ...
      if (
        ...
        // Défense en profondeur (fusion #23, restaurée lors de la fusion tokoo ×THRIVE
      ...
      // publié hors tokoo , handleIncomingComment recrée cette ligne à
