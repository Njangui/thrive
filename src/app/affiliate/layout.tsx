    ...
    <div className="min-h-screen bg-slate-50 text-navy-900">
      ...
      <div className="flex min-h-screen">
        <aside className="hidden w-[248px] shrink-0 flex-col bg-navy-900 px-3 py-5 lg:flex">
          <div className="mb-7 px-2"><flexco Brand href="/" dark /></div>
          ...
          {affiliate?.status === "active" ? (
            ...
            <nav className="flex flex-1 flex-col gap-1">
              ...
              <Link href="/" className="mt-auto rounded-xl px-3 py-2.5 text-sm font-medium text-white/55 hover:text-white">← Retour à flexco </Link>
            </nav>
          )}
        </aside>
