...
export default function ResetPasswordPage() { return <Suspense fallback={null}><AuthShell mode="reset" title="Réinitialiser votre mot de passe" subtitle="Choisissez un nouveau mot de passe pour retrouver votre espace CRESYVA."><ResetForm /></AuthShell></Suspense>; }
