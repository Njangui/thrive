 ...
 *
 * Portail vers `document.body` + blocage du scroll pendant l'ouverture :
 * même correctif que `DashboardMobileNav` (voir sa note) — ce tiroir est
 * rendu dans le `<header>` de `AdminTopbar`, qui porte aussi
 * `backdrop-blur`, donc sujet au même bug de containing block CSS.
 */
            ...
            <div className="fixed inset-0 z-50 flex h-dvh">
              ...
              <div className="flex h-full w-[280px] flex-col overflow-y-auto bg-navy-900 px-3 py-5">
                <div className="mb-4 flex items-center justify-between px-2">
                  <div onClick={() => setOpen(false)}><FlexcoBrand href="/admin" compact dark /></div>
