    ...
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Contrôle de la disponibilité commerciale de flexco  par pays. NotchPay indique ce qui est techniquement
      ...
      <section className="grid gap-4 sm:grid-cols-4">
        ...
        <div className="rounded-xl border border-navy-900/10 bg-white p-4">
          <p className="text-xs uppercase tracking-wide text-slate-500">Actifs flexco </p>
        ...
        <table className="w-full text-sm">
          <thead className="border-b border-navy-900/10 text-left text-xs uppercase text-slate-500">
            <tr>
              ...
              <th className="px-4 py-2">flexco </th>
