...
export const metadata: Metadata = {
  title: "Tarifs — SME-OS",
  description: "Des offres simples pour piloter votre entreprise avec SME-OS.",
};
...
export default async function PricingPage() {
  ...
  return <main className="pricing-page"><header className="pricing-nav"><Link href="/" className="auth-logo"><span className="auth-logo-mark">S</span><span>SME-OS</span></Link><nav><Link href="/">Accueil</Link><Link href="/devenir-affilie">Devenir affilié</Link><Link href="/login">Connexion</Link></nav><Link href="/signup" className="mkt-btn-primary !px-5 !py-2.5">Commencer</Link></header>
