...
export async function generateMetadata(): Promise<Metadata> {
  return buildMarketingMetadata({
    path: "/tarifs",
    title: "Tarifs — tokoo ",
    description: "Discover gratuit, Starter et Pro : des offres tokoo  simples et progressives.",
  });
}
  ...
  return (
    <main className="pricing-page">
      <header className="pricing-nav">
        <Link href="/" className="auth-logo"><span className="auth-logo-mark">C</span><span>tokoo </span></Link>
      ...
      <section className="pricing-hero">
        <span className="mkt-badge-pill">Freemium tokoo </span>
      ...
      <section className="pricing-bottom">
        <div>
          ...
          <p>Votre numéro WhatsApp Business existant peut rester utilisable dans l&apos;application grâce à la coexistence. Les Groupes WhatsApp utilisent un numéro distinct connecté en Cloud API uniquement. Le numéro fourni par tokoo  est facturé séparément.</p>
        </div>
