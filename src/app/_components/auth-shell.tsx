...
export function AuthShell({
  ...
  const copy = mode === "signup"
    ...
    : mode === "reset"
      ...
      : { kicker: "Bienvenue sur flexco ", title: "Pilotez votre entreprise avec plus de clarté.", body: "Un espace unique pour vendre, suivre vos clients et développer votre activité." };
    ...
    <main className="auth-page">
      ...
      <div className="auth-layout">
        ...
        <section className="auth-form-panel">
          <div className="auth-mobile-logo"><flexco Brand compact dark /></div>
          ...
          <p className="auth-footer">© {new Date().getFullYear()} flexco  · Une solution pensée pour les PME africaines.</p>
        </section>
      </div>
    </main>
  );
