...
export async function generateMetadata(): Promise<Metadata> {
  return buildMarketingMetadata({
    path: "/cgu",
    title: "Conditions générales d'utilisation — Flexco",
    description: "Les conditions d'utilisation de la plateforme Flexco : compte, abonnements, paiement et responsabilités.",
...
export default function CguPage() {
  ...
  return (
    <LegalPageLayout title="Conditions générales d'utilisation (CGU)">
      ...
      <h2>1. Objet</h2>
      <p>
        Flexco est une plateforme logicielle (SaaS) permettant à une entreprise (« le Client ») de gérer son
      ...
      <p>
        ...
        de bord. Le paiement des offres payantes est traité par notre prestataire de paiement (Fapshi) ; Flexco ne
      ...
      <p>
        ...
        de bord. Flexco s&apos;efforce de lui envoyer un rappel environ trois (3) jours avant l&apos;échéance. Si
      ...
      <p>
        ...
        propriété. Flexco ne les utilise que pour fournir le service, et ne les cède ni ne les vend à des tiers —
      ...
      <p>
        Flexco met en œuvre des moyens raisonnables pour assurer la disponibilité du service, sans garantie
      ...
      <p>
        Flexco est tenue à une obligation de moyens. Dans la mesure permise par la loi, Flexco ne saurait être
        ...
        exportées par le Client. Toujours dans la mesure permise par la loi, la responsabilité totale de Flexco au
      ...
      <p>
        Flexco peut modifier les présentes CGU. Le Client sera informé de toute modification substantielle par
