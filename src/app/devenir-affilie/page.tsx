...
export async function generateMetadata(): Promise<Metadata> {
  return buildMarketingMetadata({
    ...
    title: "Devenir affilié — Flexco",
    description: "Recommandez Flexco et gagnez une commission sur les nouveaux abonnements.",
  });
}
