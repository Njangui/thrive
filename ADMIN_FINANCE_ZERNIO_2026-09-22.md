# flexco  — Finance Super Admin & calculateur Zernio
...
- Le coût Zernio est calculé à partir des comptes Zernio actuellement connectés dans flexco  : `social_accounts`, `whatsapp_accounts` et les connexions dédiées aux groupes WhatsApp. Les chaînes YouTube ne sont pas comptées car flexco  les connecte via son intégration Google directe.
...
- L'ancienne pastille « S / flexco  Admin » du menu admin mobile a été remplacée par le vrai composant de marque flexco .
