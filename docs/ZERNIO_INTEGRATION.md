...
l'id du groupe lui-même` (`external_id` côté flexco ). La conversation
...
- **CÂBLÉ au Lot 5 (20/09/2026)**, contrairement à la note originale de ce
  ...
  plateforme (hors flexco ) — jusque-là structurellement impossible
  ...
  par flexco  — voir 0064_external_post_tracking.sql, qui ajoute
...
Trois choses différentes portent le nom « WhatsApp » dans flexco . Ne jamais les confondre :
