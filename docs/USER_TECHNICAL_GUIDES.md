...
flexco  masque volontairement les fournisseurs et détails d'infrastructure. L'utilisateur doit voir **quoi faire**, pas « quel API/SDK tourne derrière ».
...
5. Le coller dans flexco  puis cliquer `Connecter mon bot`.
6. flexco  vérifie le token et configure le webhook automatiquement.
...
5. Revenir automatiquement dans flexco .
