...
-- un post publié directement sur la plateforme (hors composer flexco )
...
-- pour un post que flexco  n'a pas publié lui-même, détecté par la
...
-- Distingue un post publié depuis flexco  ('app', comportement
...
comment on column social_posts.source is
  'Lot 5 : ''app'' = publié via le composer flexco  (comportement '
