...
-- Finance interne CRESYVA : dépenses de plateforme et pilotage Zernio.
...
comment on table platform_expenses is
  'Dépenses internes de la plateforme CRESYVA. Lecture/écriture exclusivement via la console Super Admin (service role).';
