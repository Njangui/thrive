...
-- Financial cockpit flexco  + comptabilité de gestion tenant.
--
-- Principes :
...
select * from (values
  ...
  ('flexco ', 'Salaires / rémunérations', 'salary', 'operating', 'fixed', 'monthly', null::numeric, 'Renseigner uniquement lorsque ce coût est réellement engagé.')
